...
public class TelaPesquisaSintoma extends javax.swing.JInternalFrame {

    public TelaPesquisaSintoma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisa Sintoma");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaSintoma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPesquisaSintoma().setVisible(true);
            }
        });
    }
