...
public class TelaCadastroSintoma extends javax.swing.JInternalFrame{

    public TelaCadastroSintoma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Sintoma");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroSintoma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroSintoma().setVisible(true);
            }
        });
    }
