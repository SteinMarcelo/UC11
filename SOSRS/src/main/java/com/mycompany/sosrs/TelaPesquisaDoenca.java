...
public class TelaPesquisaDoenca extends javax.swing.JFrame {

    public TelaPesquisaDoenca() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisa Doença");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaDoenca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPesquisaDoenca().setVisible(true);
            }
        });
    }
